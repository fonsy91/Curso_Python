...
'''
columnspan: hace que se alarge el numero de columnas que indiques 
'''

#pantalla de la calculadora ------------------------------- 
#asociamos esta variable a la pantalla con textvariable en variable pantalla 
operacion=""
resultado=0
...
botonDiv=Button(miFrame, text="/", width=5, command=lambda:divide(numeroPantalla.get()))
...
botonMult=Button(miFrame, text="x", width=5, command=lambda:multiplica(numeroPantalla.get()))
...
botonRest=Button(miFrame, text="-", width=5, command=lambda:resta(numeroPantalla.get()))
...
botonSum=Button(miFrame, text="+", width=5, command=lambda: suma(numeroPantalla.get()))
